...
{:else if name === 'green-circle'}
	<svg class={iconClasses} fill="currentColor" viewBox="0 0 24 24">
		<circle cx="12" cy="12" r="10" class="text-green-500"></circle>
	</svg>
...
{:else if name === 'loading'}
	<svg class={iconClasses} fill="none" stroke="currentColor" viewBox="0 0 24 24">
		<path
			...
			stroke-linejoin="round"
			stroke-width="2"
			d="M12 2v4m0 12v4m8-8h-4M6 12H2m15.364-6.364l-2.828 2.828M6.343 6.343l2.828 2.828m0 5.657l2.828 2.828M6.343 17.657l2.828-2.828"
		>
			<animateTransform
